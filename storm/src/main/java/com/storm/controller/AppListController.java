...
public class AppListController 
{
	...
	public	ModelAndView	appView(@RequestParam(value="nowPage", defaultValue="1")int nowPage, int app_id)
	{
	...
	public String	imgurl(String app_id)
	{
		String url = appService.getAppUrl(Integer.parseInt(app_id));
