		...
		<div	id="content">
			<table>
				...
				<c:if	test="${not empty sessionScope.UID}">
  							<h4>댓글쓰기</h4>
  								<form role="form"	action="../Commu/CommuReplyProc.storm">
  									<input type="hidden" id="board_app_id" name="gno" >
  									<input type="hidden" id="board_user_key" name="originUID" >
					...
					<table style="width: 100%; border: 0px solid gray;" >
						<tr>
							...
							<div class="col-sm-2 text-center">
 							...
 							<div class="col-sm-10">
 								<h4>
 									<small>닉네임 :</small>${board_user_key}
