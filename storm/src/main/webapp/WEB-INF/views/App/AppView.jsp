...
<body>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
  			<h3 class="panel-title"><h1>${APP_INFO.title}</h1></h3>
  			
		</div>
		<div class="panel-body">
			<img src="${APP_INFO.imgURL}" align="center" style="width:33%; margin:auto; float:left;"/>
  			<p>${APP_INFO.text}</p>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body" >
  			<div class="panel panel-primary" style="float:left; width:50%;">
				<div class="panel-heading">
  					<h3 class="panel-title">추천 리뷰 키워드</h3>
				</div>
				<div class="panel-body" >
  					<div id="positiveCloud" style="width: 550px; height: 350px"></div>
				</div>
			</div>
			<div class="panel panel-danger"  style="float:left; width:50%;">
				<div class="panel-heading">
  					<h3 class="panel-title">비추천 리뷰 키워드</h3>
				</div>
				<div class="panel-body">
